        ...
        <li class="nav-item dropdown" id="profileItem">
            <?php if(Auth::check()): ?>
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="profile-initial"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?php echo e(route('parcour')); ?>">Mon parcours</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('editprofil')); ?>" onclick="editProfile()">Éditer mon profil</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('Invitation.create')); ?>" onclick="Invitation()">Inviter un ami</a></li> <!-- Ajout de l'option "Inviter un ami" -->
                    <li>
...
<script>
    ...
    function Invitation() {
        ...
        window.location.href = "<?php echo e(route('Invitation.create')); ?>";  
    }
				...
				<div class="list-topics-content">
					...
					<section id="works" class="works">
						<div class="section-header">
							<h2><i><a href="<?php echo e(route('formation')); ?>"><input type="button" value="Voir plus..."></a></i>
							</i></h2>
...
<?php /**PATH C:\xampp\htdocs\Layeformation\resources\views/components/header.blade.php ENDPATH**/ ?>
...
<div class="card">
    ...
    <div class="card-body" style="overflow-y: auto; max-height: 500px;"> <!-- Permet de faire défiler les questions -->
        <form action="<?php echo e(route('quiz.store')); ?>" method="POST" id="quiz-form">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Layeformation\resources\views/quiz/create.blade.php ENDPATH**/ ?>
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <div class="nav-item" data-target="dashboard">
                <a href="<?php echo e(route('dashboard')); ?>" style="color: inherit; text-decoration: none;">Tableau de bord</a>
            </div>

            <div class="nav-item" data-target="courses">
                <a href="<?php echo e(route('formations.index')); ?>" style="color: inherit; text-decoration: none;">Cours</a>
            </div>

            <div class="nav-item" data-target="modules">
                <a href="<?php echo e(route('modules.index')); ?>" style="color: inherit; text-decoration: none;">Modules</a>
            </div>


            <div class="nav-item" data-target="students">
                <a href="<?php echo e(route('etudiants.index')); ?>" style="color: inherit; text-decoration: none;">Étudiants</a>
            </div>

            <div class="nav-item" data-target="trainers">
                <a href="<?php echo e(route('formateurs.index')); ?>" style="color: inherit; text-decoration: none;">Formateurs</a>
            </div>

             <div class="nav-item" data-target="reports">
                <a href="<?php echo e(route('domaines.index')); ?>" style="color: inherit; text-decoration: none;">Domaines</a>
            </div>
            ...
            <div class="nav-item" data-target="reports">
                <a href="<?php echo e(route('chapitres.index')); ?>" style="color: inherit; text-decoration: none;">Chapitres</a>
            </div>

            <div class="nav-item" data-target="reports">
                <a href="<?php echo e(route('quiz.index')); ?>" style="color: inherit; text-decoration: none;">Quiz</a>
            </div>
    ...
    <p>Gérez les modules associés aux cours.</p>
    <a href="<?php echo e(route('modules.create')); ?>" class="btn btn-primary mb-3">Ajouter un Nouveau Module</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?php echo e($module->video_url); ?>" target="_blank">Voir Vidéo</a></td>
                <td><?php echo e($module->name); ?></td>
                <td>
                    <a href="<?php echo e(route('modules.edit', $module->id)); ?>" class="btn btn-warning btn-sm">Modifier</a>
...
<?php /**PATH C:\xampp\htdocs\Layeformation\resources\views/components/dashboard.blade.php ENDPATH**/ ?>